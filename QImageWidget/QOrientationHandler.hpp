...
public:
	...
	static util::FixedVector<float, 6> getViewPort( const boost::shared_ptr< ImageHolder > image, const size_t &w, const size_t &h, const float &zoom, PlaneOrientation orientation, bool move );
